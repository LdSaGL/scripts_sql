INSERT INTO producer (id_producer, producer_name, photo)
VALUES (1, 'sony', NULL),
       (2, '30praum', NULL),
       (3, 'universal', NULL),
	   (4, 'globo', NULL),
...
INSERT INTO artist (id_artist, artist_name, date_of_birth, photo)
...
INSERT INTO album (id_album, album_name, almbum_creation_date, cover, fk_producer_id_producer)
...
INSERT INTO "group" (id_grupo, group_name, group_creation_date)
...
INSERT INTO genre (id_genre, genre_name, "description")
VALUES (1, 'pop', NULL),
       (2, 'trap', NULL),
       (3, 'eletronica', NULL),
	   (4, 'indie', NULL),
...
INSERT INTO radio (id_radio, radio_name)
VALUES (1, 'mix'),
       (2, 'joven pan'),
       (3, 'clube fm'),
	   (4, 'verde oliva'),
...
INSERT INTO user (id_user, username, date_of_birth, email, "password", phone, photo, is_admin)
...
INSERT INTO "show" (id_show, video, show_name, show_creation_date)
...
INSERT INTO playlist (id_playlist, playlist_name, cover, playlist_creation_date, fk_user_id_user)
...
INSERT INTO music (id_musica, music_name, clip, lyrics, "language", fk_artist_id_artist, fk_genre_id_genre, fk_album_id_album)
